...
lib.ssMetadata = [
		{name:"14_atlas_1", frames: [[0,0,1173,1533]]},
		{name:"14_atlas_2", frames: [[0,902,344,174],[0,0,1200,900]]}
];
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(34,55,0.4978,0.4978);
...
p.nominalBounds = new cjs.Rectangle(635.2,354,650.3,467.5);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/14_atlas_1.png?1686578996188", id:"14_atlas_1"},
		{src:"images/14_atlas_2.png?1686578996188", id:"14_atlas_2"}
	],
	preloads: []
};
