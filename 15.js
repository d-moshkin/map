...
lib.ssMetadata = [
		{name:"15_atlas_1", frames: [[924,1539,344,174],[0,0,1173,1537],[0,1539,460,345],[462,1539,460,345]]}
];
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(266,341,0.7507,0.7507);

	this.instance_1 = new lib.Растровоеизображение6();
	this.instance_1.setTransform(35,41,0.787,0.787);

	this.instance_2 = new lib.CachedBmp_3();
	this.instance_2.setTransform(643.95,41,0.5,0.5);
...
p.nominalBounds = new cjs.Rectangle(635.2,354,650.3,455.5);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/15_atlas_1.png?1686579758822", id:"15_atlas_1"}
	],
	preloads: []
};
