...
lib.ssMetadata = [
		{name:"20_atlas_1", frames: [[0,0,1173,1542]]},
		{name:"20_atlas_2", frames: [[0,855,344,174],[0,0,1280,853]]}
];
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(24,46,0.4687,0.4687);
...
p.nominalBounds = new cjs.Rectangle(635.2,354,650.3,458);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/20_atlas_1.png?1686685273846", id:"20_atlas_1"},
		{src:"images/20_atlas_2.png?1686685273846", id:"20_atlas_2"}
	],
	preloads: []
};
