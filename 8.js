...
lib.ssMetadata = [
		{name:"8_atlas_1", frames: [[0,0,1500,960]]},
		{name:"8_atlas_2", frames: [[0,1182,344,174],[0,0,1141,1180]]}
];
...
if (reversed == null) { reversed = false; }
	...
	// Текст
	this.instance = new lib.Псков2();
	this.instance.setTransform(30,55,0.4041,0.4041);

	this.instance_1 = new lib.CachedBmp_1();
	this.instance_1.setTransform(660,55,0.5,0.5);
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/8_atlas_1.png?1686576158350", id:"8_atlas_1"},
		{src:"images/8_atlas_2.png?1686576158350", id:"8_atlas_2"}
	],
	preloads: []
};
