...
lib.ssMetadata = [
		{name:"18_atlas_1", frames: [[0,0,1173,1448]]},
		{name:"18_atlas_2", frames: [[0,612,344,174],[0,0,1000,610]]}
];
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(19,41,0.6021,0.6021);
...
p.nominalBounds = new cjs.Rectangle(635.2,354,650.3,411);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/18_atlas_1.png?1686599108893", id:"18_atlas_1"},
		{src:"images/18_atlas_2.png?1686599108893", id:"18_atlas_2"}
	],
	preloads: []
};
