...
lib.ssMetadata = [
		{name:"5_atlas_1", frames: [[1102,1412,344,174],[0,0,1173,1410],[0,1412,1100,600]]}
];
...
if (reversed == null) { reversed = false; }
	...
	// Текст
	this.instance = new lib.Кижскийпогост();
	this.instance.setTransform(39,55,0.5158,0.5158);
...
p.nominalBounds = new cjs.Rectangle(638,357,648.4000000000001,403);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/5_atlas_1.png?1686515778478", id:"5_atlas_1"}
	],
	preloads: []
};
