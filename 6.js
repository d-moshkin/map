...
lib.ssMetadata = [
		{name:"6_atlas_1", frames: [[0,0,1209,1331]]},
		{name:"6_atlas_2", frames: [[0,802,344,174],[0,0,1200,800]]}
];
...
(lib.CachedBmp_1 = function() {
	this.initialize(ss["6_atlas_1"]);
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();



(lib.Соловецкие2 = function() {
	this.initialize(ss["6_atlas_2"]);
	this.gotoAndStop(1);
}).prototype = p = new cjs.Sprite();
...
if (reversed == null) { reversed = false; }
	...
	// Текст
	this.instance = new lib.Соловецкие2();
	this.instance.setTransform(20,55,0.4815,0.4815);

	this.instance_1 = new lib.CachedBmp_1();
	this.instance_1.setTransform(626,55,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_1},{t:this.instance}]}).wait(1));

	// Фон
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFF3AE").s().p("EhkpA4lMAAAhxJMDJTAAAMAAABxJg");
	this.shape.setTransform(642.15,359.1);
...
p.nominalBounds = new cjs.Rectangle(638,357,648.4000000000001,364.20000000000005);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/6_atlas_1.png?1686567956935", id:"6_atlas_1"},
		{src:"images/6_atlas_2.png?1686567956935", id:"6_atlas_2"}
	],
	preloads: []
};
