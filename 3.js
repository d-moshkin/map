...
lib.ssMetadata = [
		{name:"3_atlas_1", frames: [[643,1455,344,174],[0,0,1173,1453],[0,1455,641,426]]}
];
...
if (reversed == null) { reversed = false; }
	...
	// Текст
	this.instance = new lib.Питер3();
	this.instance.setTransform(54,60,0.8886,0.8604);
...
p.nominalBounds = new cjs.Rectangle(638,357,648.4000000000001,424.5);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/3_atlas_1.png?1686508810642", id:"3_atlas_1"}
	],
	preloads: []
};
