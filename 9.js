...
lib.ssMetadata = [
		{name:"9_atlas_1", frames: [[782,1234,344,174],[0,0,1077,1232],[0,1234,780,520]]}
];
...
if (reversed == null) { reversed = false; }
	...
	// Текст
	this.instance = new lib.Петроглифы();
	this.instance.setTransform(32,55,0.8153,0.8153);
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/9_atlas_1.png?1686577046516", id:"9_atlas_1"}
	],
	preloads: []
};
