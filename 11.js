...
lib.ssMetadata = [
		{name:"11_atlas_1", frames: [[0,902,344,174],[0,0,1200,900]]},
		{name:"11_atlas_2", frames: [[0,0,1173,1260]]}
];
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(643.95,55,0.5,0.5);

	this.instance_1 = new lib.Пинеж();
	this.instance_1.setTransform(60,55,0.4645,0.4645);
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/11_atlas_1.png?1686233369645", id:"11_atlas_1"},
		{src:"images/11_atlas_2.png?1686233369645", id:"11_atlas_2"}
	],
	preloads: []
};
