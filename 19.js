...
lib.ssMetadata = [
		{name:"19_atlas_1", frames: [[0,660,344,174],[0,0,1280,658]]},
		{name:"19_atlas_2", frames: [[0,0,1173,1637]]}
];
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(21,41,0.4726,0.4726);
...
p.nominalBounds = new cjs.Rectangle(635.2,354,650.3,505.5);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/19_atlas_1.png?1686600018266", id:"19_atlas_1"},
		{src:"images/19_atlas_2.png?1686600018266", id:"19_atlas_2"}
	],
	preloads: []
};
