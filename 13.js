...
lib.ssMetadata = [
		{name:"13_atlas_1", frames: [[782,1182,344,174],[0,0,1077,1180],[0,1182,780,520]]}
];
...
if (reversed == null) { reversed = false; }
	...
	// Текст
	this.instance = new lib.Струве();
	this.instance.setTransform(37,55,0.7972,0.7972);
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/13_atlas_1.png?1686577629801", id:"13_atlas_1"}
	],
	preloads: []
};
