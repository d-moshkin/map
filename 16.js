...
lib.ssMetadata = [
		{name:"16_atlas_1", frames: [[0,0,1173,1495]]},
		{name:"16_atlas_2", frames: [[0,684,344,174],[0,0,1024,682]]}
];
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(30,41,0.5717,0.5717);
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/16_atlas_1.png?1686583333596", id:"16_atlas_1"},
		{src:"images/16_atlas_2.png?1686583333596", id:"16_atlas_2"}
	],
	preloads: []
};
