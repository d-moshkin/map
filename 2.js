...
lib.ssMetadata = [
		{name:"2_atlas_1", frames: [[1175,522,344,174],[0,0,1173,971],[1175,0,780,520],[0,973,1157,628]]}
];
...
if (reversed == null) { reversed = false; }
	...
	// Текст
	this.instance = new lib.Куршская();
	this.instance.setTransform(45,55,0.6872,0.6872);

	this.instance_1 = new lib.Куршская2();
	this.instance_1.setTransform(656,412,0.4671,0.4671);
...
p.nominalBounds = new cjs.Rectangle(635.2,354,650.3,372.20000000000005);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/2_atlas_1.png?1686506421113", id:"2_atlas_1"}
	],
	preloads: []
};
