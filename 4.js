...
lib.ssMetadata = [
		{name:"4_atlas_1", frames: [[0,1286,344,174],[0,0,1173,1284]]}
];
...
(lib.Вологда2 = function() {
	this.initialize(img.Вологда2);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,3934,2213);
...
if (reversed == null) { reversed = false; }
	...
	// Текст
	this.instance = new lib.Вологда2();
	this.instance.setTransform(40,55,0.1452,0.1452);
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/Вологда2.png?1686509418648", id:"Вологда2"},
		{src:"images/4_atlas_1.png?1686509418637", id:"4_atlas_1"}
	],
	preloads: []
};
