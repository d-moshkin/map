...
lib.ssMetadata = [
		{name:"7_atlas_1", frames: [[643,1125,344,174],[0,0,1141,1123],[0,1125,641,446]]}
];
...
if (reversed == null) { reversed = false; }
	...
	// Текст
	this.instance = new lib.Новгород3();
	this.instance.setTransform(30,55,0.9474,0.9474);
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/7_atlas_1.png?1686575821944", id:"7_atlas_1"}
	],
	preloads: []
};
