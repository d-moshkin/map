...
lib.ssMetadata = [
		{name:"12_atlas_1", frames: [[0,0,1173,1443]]},
		{name:"12_atlas_2", frames: [[1201,873,344,174],[0,873,1199,800],[0,0,1565,871]]}
];
...
if (reversed == null) { reversed = false; }
	...
	// Текст
	this.instance = new lib.печо();
	this.instance.setTransform(52,55,0.3627,0.3627);

	this.instance_1 = new lib.Печор();
	this.instance_1.setTransform(242,384,0.3147,0.3147);

	this.instance_2 = new lib.CachedBmp_1();
	this.instance_2.setTransform(643.95,55,0.5,0.5);
...
p.nominalBounds = new cjs.Rectangle(635.2,354,650.3,422.5);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/12_atlas_1.png?1686334188926", id:"12_atlas_1"},
		{src:"images/12_atlas_2.png?1686334188926", id:"12_atlas_2"}
	],
	preloads: []
};
